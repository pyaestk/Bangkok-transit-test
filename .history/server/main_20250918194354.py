...
stations = [
    ...
    {"id": "S1", "name": "Khu Khot", "x": 600, "y": 100, "line": "green"},
    {"id": "S2", "name": "Yaek Kor Por Aor", "x": 500, "y": 200, "line": "green"},
    {"id": "S3", "name": "Phahon Yothin 59", "x": 500, "y": 300, "line": "green"},  # intersection
    {"id": "S4", "name": "Sai Yud", "x": 500, "y": 400, "line": "green"},

    # Pink Line
    {"id": "P1", "name": "Central Plaza", "x": 400, "y": 300, "line": "pink"},
    {"id": "P2", "name": "Phahon Yothin 59", "x": 500, "y": 300, "line": "pink"},  # intersection with S3
    {"id": "P3", "name": "Ratchada", "x": 600, "y": 300, "line": "pink"},
]
...
connections = [
    ...
    # Pink Line
    {"from": "P1", "to": "P2", "line": "pink"},
    {"from": "P2", "to": "P3", "line": "pink"},
]
